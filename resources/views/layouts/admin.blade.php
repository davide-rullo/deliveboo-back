                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                    <div class="position-sticky pt-3">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="">
                                <a class="d-md-none nav-link text-muted {{ Route::currentRouteName() == '/' ? 'bg_my_light-pink' : '' }}" href="{{ url('/') }}">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link text-muted {{ Route::currentRouteName() == 'admin.dashboard' ? 'bg_my_light-pink' : '' }}" href="{{ route('admin.dashboard') }}">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link text-muted {{ Route::currentRouteName() == 'admin.restaurants.index' ? 'bg_my_light-pink' : '' }}" href="{{ route('admin.restaurants.index') }}">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link text-muted {{ Route::currentRouteName() == 'admin.plates.index' ? 'bg_my_light-pink' : '' }}" href="{{ route('admin.plates.index') }}">
