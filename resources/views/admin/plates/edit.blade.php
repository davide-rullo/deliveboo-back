    ...
    <div class="container">
        ...
        <form action="{{ route('admin.plates.update', $plate) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" @error('name') is-invalid @enderror name="name" id="name" aria-describedby="helpId" placeholder="Write the name of your plate" value="{{ old('name', $plate->name) }}" required>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" @error('description') is-invalid @enderror name="description" id="description" aria-describedby="descriptionHelper" placeholder="Describe your dish" value="{{ old('description') }}"></textarea>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" @error('ingredients') is-invalid @enderror name="ingredients" id="ingredients" aria-describedby="ingredientsHelper" placeholder="Acciughe...." value="{{ old('ingredients') }}">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" name="cover_image" id="cover_image" placeholder="" aria-describedby="image_helper">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="1" max="99" step=".01" class="form-control" @error('price') is-invalid @enderror name="price" id="price" aria-describedby="priceHelper" placeholder="9,99" value="{{ old('price') }}" required>
