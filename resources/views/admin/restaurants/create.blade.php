            ...
            <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @forelse ($types as $type)
                            <li>
                                <div class="form-check">
                                    <input class="form-check-input mx-1" @error('name') is-invalid @enderror type="checkbox"
                                        name="types[]" value="{{ $type->id }}" id="type{{ $type->id }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" minlength="11" maxlength="16" class="form-control"
                        ...
                        aria-describedby="vat_numberHelper" placeholder="0123456789" value="{{ old('vat_number') }}">
                    <small id="vat_numberHelper" class="form-text text-muted">
